    ...
    <section>
      ...
      <div
        className="prose prose-invert prose-neutral max-w-none
          ...
          [&_h1]:text-2xl [&_h1]:font-semibold [&_h1]:tracking-tighter [&_h1]:bg-clip-text [&_h1]:text-transparent [&_h1]:bg-linear-to-b [&_h1]:from-white [&_h1]:to-neutral-400 [&_h1]:transition-colors
          [&_h2]:text-xl [&_h2]:font-semibold [&_h2]:tracking-tighter [&_h2]:bg-clip-text [&_h2]:text-transparent [&_h2]:bg-linear-to-b [&_h2]:from-white [&_h2]:to-neutral-400 [&_h2]:transition-colors
          [&_h3]:text-lg [&_h3]:font-semibold [&_h3]:tracking-tighter [&_h3]:bg-clip-text [&_h3]:text-transparent [&_h3]:bg-linear-to-b [&_h3]:from-white [&_h3]:to-neutral-400 [&_h3]:transition-colors
          [&_h4]:font-semibold [&_h4]:tracking-tighter [&_h4]:bg-clip-text [&_h4]:text-transparent [&_h4]:bg-linear-to-b [&_h4]:from-white [&_h4]:to-neutral-400 [&_h4]:transition-colors
